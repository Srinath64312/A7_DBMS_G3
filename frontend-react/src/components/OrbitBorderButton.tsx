...
export type OrbitBorderButtonProps = {
    ...
    icon?: OrbitIconValue
    gap?: number
    border?: OrbitBorderValue
    stroke?: OrbitStrokeValue
    spot?: OrbitStrokeValue
    hoverScale?: number
    link?: string
...
export function OrbitBorderButton(props: OrbitBorderButtonProps) {
    const {
        label = "ORBIT BORDER",
        children,
        font = {
    ...
    return (
        <div
            ...
            className={`inline-flex relative select-none ${className}`}
            style={{
                minWidth: 80,
                minHeight: 38,
                position: "relative",
            ...
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        alignItems: "center",
                        justifyContent: "center",
                        gap: hasIcon && (showText || children) ? gap : 0,
                        flexDirection:
                ...
                >
                    ...
                    {children ? children : (showText && <span>{label}</span>)}
                </div>
            </Tag>
        </div>
    )

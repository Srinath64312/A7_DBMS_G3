...
Handles stock tracking, multi-warehouse distribution, and reservations.
"""
import uuid
import logging
...
def get_warehouses():
    return db.pg_query_all("SELECT * FROM warehouses ORDER BY name ASC")
...
def get_product_inventory(product_id):
    ...
    ORDER BY w.name ASC
    """
    return db.pg_query_all(sql, (product_id,))
